Feature: HBaseDao
  ...
  Scenario Outline: 前缀模糊和时间范围查询，且带有后缀
    Given 表名为"<tableName>"
    And 要创建表的familyNames是"<familyNames>"
    And 数据表创建成功
    And 要插入数据的qualifiers为"<qualifiers>"
    ...
    Then 查询到"<resultCount>"条数据
    Examples:
      | tableName | familyNames | qualifiers | prefix | suffix | insertTime    | startTime     | stopTime      | resultCount |
      | llt-test  | t           | col1       | (      | abc    | 1514522700000 | 1514522600000 | 1514522800000 | 1           |
      | llt-test  | t           | col1       |        | abc    | 1514522700000 | 1514522600000 | 1514522800000 | 1           |
      | llt-test  | t           | col1       | (      | abc    | 1514522600000 | 1514522600000 | 1514522800000 | 1           |
      | llt-test  | t           | col1       | (      | abc    | 1514522800000 | 1514522600000 | 1514522800000 | 0           |
      | llt-test  | t           | col1       | ()     | abc    | 1514522700000 | 1514522600000 | 1514522800000 | 1           |
